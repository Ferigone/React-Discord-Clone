    ...
    return (
        <div className='flex flex-col justify-center items-center bg-gray-primary p-[32px] rounded-md z-10'>
            ...
            <form onSubmit={onSubmit} className='flex flex-col w-full'>
                ...
                <input type="text" id='email' required className='bg-dark-gray w-[414px] h-[40px] rounded-sm mb-4 outline-none p-3' />
                <label htmlFor="password" className='font-bold text-light-gray mb-2 text-[12px]'>HASŁO</label>
                <input type="password" id='password' required className='bg-dark-gray w-[414px] h-[40px] rounded-sm mb-2 outline-none p-3' />
                <a href="" className='text-[14px] text-link-blue font-semibold'>Nie pamiętasz hasła?</a>
                <button type='submit' className='w-full bg-dark-blue h-[44px] rounded-sm font-semibold mb-2 mt-6'>Zaloguj się</button>
