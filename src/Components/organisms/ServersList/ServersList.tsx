  ...
  return (
      <>
        <div className="w-[72px] min-w-[72px] bg-primary flex flex-col items-center py-3">
          <div
              className="mb-2 bg-secondary group hover:bg-blue min-h-[48px] min-w-[48px] flex items-center justify-center rounded-3xl hover:rounded-2xl duration-100 cursor-pointer">
          ...
          <div className="block overflow-auto no-scrollbar">
            {servers.map((server) => (
                ...
                >
                  ...
                  >
                    <div
                        className="mb-2 bg-secondary group hover:bg-blue h-[48px] w-[48px] flex items-center justify-center rounded-3xl hover:rounded-2xl duration-100 cursor-pointer">
