...
const NewServerModal = ({ title, setVisible, addServer }: Props) => {
      ...
      <ModalHeader>
        <div>
          ...
          <p className="text-gray-500 mt-3">
            By {modalStatus === "create" ? "creating" : "joining"} a server, you
            will have access to free text-based channels to use amongst your
            friends.
          </p>
        </div>
      </ModalHeader>
